...
package gen // import "github.com/go-corelibs/x-text/internal/gen"
...
const header = `// Code generated by running "go generate" in github.com/go-corelibs/x-text. DO NOT EDIT.
...
func localReadmeFile() (string, error) {
	p, err := build.Import("github.com/go-corelibs/x-text", "", build.FindOnly)
	if err != nil {
...
const readmeTxt = `Generated by github.com/go-corelibs/x-text/internal/gen. DO NOT EDIT.

This directory contains downloaded files used to generate the various tables
in the github.com/go-corelibs/x-text subrepo.
