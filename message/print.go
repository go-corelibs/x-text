...
import (
	...
	"github.com/go-corelibs/x-text/internal/number"
...
// It implements "github.com/go-corelibs/x-text/internal/format".State.
type printer struct {
	Printer
...
// Language implements "github.com/go-corelibs/x-text/internal/format".State.
