...
// 1. Install gotext
//
//	go get -u github.com/go-corelibs/x-text/cmd/gotext
//	gotext -help
//
...
// see also package github.com/go-corelibs/x-text/message/catalog can be used to implement
...
// github.com/go-corelibs/x-text/feature and github.com/go-corelibs/x-text/message/catalog for more
// information.
package message
