...
package utf32 // import "github.com/go-corelibs/x-text/encoding/unicode/utf32"
...
const (
	...
	// Consistent with BOMPolicy definition in github.com/go-corelibs/x-text/encoding/unicode
)
